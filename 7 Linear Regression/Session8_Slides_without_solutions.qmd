...
-   We want a model that is as close to the real parameters as possible
    ...
    In simple terms, R² tells us how much of the total variance in the outcome (dependent variable) can be explained by the predictor(s) (independent variables) in a statistical model.
...
## Exampel for model Interpretation
