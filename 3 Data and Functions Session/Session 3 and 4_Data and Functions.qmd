...
subtitle: "Excercise 3 and 4 - Data and Functions"
...
## using functions {#sec-using-func}
...
## Calculator Function {#sec-calculator .smaller}
...
## descriptive analysis (for Exam data)
...
## New variables - for the exam data:

-   Transform ethnic group to factor

-   calculate the total points in all tests per person

-   use 300 as 100% and calculate the percentage of answers that the student got right
