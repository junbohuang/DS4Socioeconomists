...
Interpretation: The 5 values represent the average RMSE over all 5 folds for each polynomial degree. The average RMSE for the fourth degree is lower than for all other degrees. Therefore a quartic regression has the highest predictive power.
