...
#### *Part 3.1 Conceptual questions:*

1.  Explain the concepts variance, covariance.

2.  How can we use variance and covariance for calculating coefficients in a linear regression? Write down the formulas

Calculate $\hat{\beta_0}$ and $\hat{\beta_1}$ by hand. Choose the right values for your calculation:
...
#### *Part 3.2 Interpreting a given model*
...
3.  Model comparison. Compare the given model with this one (model2) - choose the better one and justify your decisiom
