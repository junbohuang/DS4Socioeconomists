...
::: callout-note
Please note that for the MC questions exactly **one** answer is correct
:::
...
The dataset consists of 111 observations. You will work with a sample (task 1.1) and the full data set (task 1.2 and task 2).
